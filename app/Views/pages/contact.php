...
<head>
	<title>Merilyen ❤️ Bize Ulaşın</title>
	<meta charset="UTF-8">
...
<body class="animsition">
					...
					<div class="right-top-bar flex-w h-full">
						...
						<?php if (session()->get('isLoggedIn')): ?>
							...
							<a href="<?= base_url('/profile') ?>" class="flex-c-m trans-04 p-lr-25">
								<?php
									$contactUserNameRaw = session()->get('user_name');
									$contactUserSurnameRaw = session()->get('user_surname');

									$contactUserName = is_scalar($contactUserNameRaw) ? (string)$contactUserNameRaw : '';
									$contactUserSurname = is_scalar($contactUserSurnameRaw) ? (string)$contactUserSurnameRaw : '';

									$contactUserFullName = htmlspecialchars(
										trim($contactUserName . ' ' . $contactUserSurname),
										ENT_QUOTES,
										'UTF-8'
									);
									?>
	...
	<!-- Title page -->
	<section class="bg-img1 txt-center p-lr-15 p-tb-92" style="background-image: url('images/siyahgri.png');">
			...
			<div class="flex-w flex-tr">
				<div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
					...
					<form action="<?= base_url('/contact/send') ?>" method="post">
						...
						<h5 class="mtext-110 cl2">
							Şikayet ve önerileriniz için bir mesaj uzağınızdayız. <br> <br>
						</h5>
				...
				<div class="size-210 bor10 flex-w flex-col-m p-lr-93 p-tb-30 p-lr-15-lg w-full-md">
					<div class="flex-w w-full p-b-42">
						...
						<div class="size-212 p-t-2">
							...
							<p class="stext-115 cl6 size-213 p-t-18">
								Çiçek Mahallesi, El Emeği Sokak No:12, Kartal / İstanbul
							</p>
						</div>
					</div>
					...
					<div class="flex-w w-full">
						...
						<div class="size-212 p-t-2">
							<span class="mtext-110 cl2">
								Satış Desteği & İş Birlikleri için
							</span>

							<p class="stext-115 cl1 size-213 p-t-18">
								iremkarayel.ik@gmail.com
							</p>
						</div>
					</div>
				</div>
	...
	<!-- Map -->
	<div class="map">
		<div class="size-303" id="google_map" data-map-x="40.888702968988184" data-map-y="29.19111489953436" data-pin="images/icons/pin.png" data-scrollwhell="0" data-draggable="1" data-zoom="11"></div>
	</div>
