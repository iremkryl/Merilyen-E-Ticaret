...
<body class="animsition">
	...
	<section class="bg-img1 txt-center p-lr-15 p-tb-92" style="background-image: url('images/sayilarla.png');">
		...
		<div class="container">
			...
			<div class="row p-b-60">
				<div class="col-md-6 col-lg-3 p-b-30">
					<div class="p-t-20 p-b-20 text-center border-statistic">
						...
						<span class="ltext-102 cl2 counter" data-target="1500">0</span>
						<span class="ltext-102 cl2">+</span>
						<p class="stext-113 cl6 p-t-10">Sipariş Teslim Edildi</p>
					</div>
				</div>
				...
				<div class="col-md-6 col-lg-3 p-b-30">
					<div class="p-t-20 p-b-20 text-center border-statistic">
						...
						<span class="ltext-102 cl2 counter" data-target="3200">0</span>
						<span class="ltext-102 cl2">+</span>
						<p class="stext-113 cl6 p-t-10">Mutlu Müşteri</p>
					</div>
				</div>
				...
				<div class="col-md-6 col-lg-3 p-b-30">
					<div class="p-t-20 p-b-20 text-center border-statistic">
						...
						<span class="ltext-102 cl2 counter" data-target="85000">0</span>
						<span class="ltext-102 cl2">m</span>
						<p class="stext-113 cl6 p-t-10">İp Kullanıldı</p>
					</div>
				</div>
				...
				<div class="col-md-6 col-lg-3 p-b-30">
					<div class="p-t-20 p-b-20 text-center border-statistic">
						...
						<span class="ltext-102 cl2 counter" data-target="35">0</span>
						<span class="ltext-102 cl2">Yıl</span>
						<p class="stext-113 cl6 p-t-10">El Emeği Tecrübesi</p>
					</div>
				</div>
			</div>
			...
			<div class="row p-b-60">
				<div class="col-md-6 col-lg-3 p-b-30">
					<div class="p-t-20 p-b-20 text-center border-statistic">
						...
						<span class="ltext-102 cl2 counter" data-target="120">0</span>
						<span class="ltext-102 cl2">+</span>
						<p class="stext-113 cl6 p-t-10">Özgün Model Tasarımı</p>
					</div>
				</div>
				...
				<div class="col-md-6 col-lg-3 p-b-30">
					<div class="p-t-20 p-b-20 text-center border-statistic">
						...
						<span class="ltext-102 cl2 counter" data-target="81">0</span>
						<p class="stext-113 cl6 p-t-10">İl'e Kargo Gönderimi</p>
					</div>
				</div>
				...
				<div class="col-md-6 col-lg-3 p-b-30">
					<div class="p-t-20 p-b-20 text-center border-statistic">
						...
						<span class="ltext-102 cl2">%</span>
						<span class="ltext-102 cl2 counter" data-target="100">0</span>
						<p class="stext-113 cl6 p-t-10">Doğa Dostu Malzeme</p>
					</div>
				</div>
				...
				<div class="col-md-6 col-lg-3 p-b-30">
					<div class="p-t-20 p-b-20 text-center border-statistic">
						...
						<span class="ltext-102 cl2 counter" data-target="3">0</span>
						<span class="ltext-102 cl2">Gün</span>
						<p class="stext-113 cl6 p-t-10">Ortalama Teslim Süresi</p>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-md-6 p-b-40">
					<h3 class="mtext-111 cl2 p-b-30">Kategori Tercih Oranları</h3>

					<div class="p-b-20">
						<div class="flex-w flex-sb-m p-b-5">
							<span class="mtext-107 cl2">Kol Çantası</span>
							<span class="mtext-107 cl2">35%</span>
						</div>
					...
					<div class="p-b-20">
						<div class="flex-w flex-sb-m p-b-5">
							<span class="mtext-107 cl2">Çapraz Çanta</span>
							<span class="mtext-107 cl2">25%</span>
						</div>
						<div class="progress" style="height: 20px;">
					...
					<div class="p-b-20">
						<div class="flex-w flex-sb-m p-b-5">
							<span class="mtext-107 cl2">El Çantası</span>
							<span class="mtext-107 cl2">15%</span>
						</div>
						<div class="progress" style="height: 20px;">
					...
					<div class="p-b-20">
						<div class="flex-w flex-sb-m p-b-5">
							<span class="mtext-107 cl2">Sırt Çantası</span>
							<span class="mtext-107 cl2">15%</span>
						</div>
						<div class="progress" style="height: 20px;">
					...
					<div class="p-b-20">
						<div class="flex-w flex-sb-m p-b-5">
							<span class="mtext-107 cl2">Yelek & Aksesuar</span>
							<span class="mtext-107 cl2">10%</span>
						</div>
						<div class="progress" style="height: 20px;">
				...
				<div class="col-md-6 p-b-40 text-center">
					<h3 class="mtext-111 cl2 p-b-40">Yıllık Sipariş Hacmi</h3>
					<div style="display:flex; justify-content:center; align-items:flex-end; height:250px; gap:30px; border-bottom: 2px solid #e6e6e6; padding-bottom: 10px;">
						...
						<div style="display:flex; flex-direction:column; align-items:center; height:100%; justify-content:flex-end;">
							<span class="stext-107 cl6 p-b-10">850</span>
							<div class="chart-bar" style="height:40%; width:60px; background:#e6e6e6;"></div>
							<span class="stext-107 cl2 p-t-10">2023</span>
						</div>

						<div style="display:flex; flex-direction:column; align-items:center; height:100%; justify-content:flex-end;">
							<span class="stext-107 cl6 p-b-10">1600</span>
							<div class="chart-bar" style="height:65%; width:60px; background:#ccc;"></div>
							<span class="stext-107 cl2 p-t-10">2024</span>
						</div>

						<div style="display:flex; flex-direction:column; align-items:center; height:100%; justify-content:flex-end;">
							<span class="stext-107 cl6 p-b-10">3200+</span>
							<div class="chart-bar" style="height:90%; width:60px; background:#717fe0;"></div>
							<span class="stext-107 cl2 p-t-10">2025</span>
						</div>

					</div>
					<p class="stext-113 cl6 p-t-20">
						Yıllara göre artan sipariş ve üretim kapasitemiz.
					</p>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-sm-6 col-lg-3 p-b-50">
					...
					<ul>
						...
						<li class="p-b-10">
							<?= base_url('/sayilarla-merilyen') ?> class="stext-107 cl7 hov-cl1 trans-04">
	...
	<script>
		...
		window.onscroll = function() {
			var menuDesktop = document.querySelector('.wrap-menu-desktop');
			var topBarHeight = 40; // Top-bar genelde 40px civarıdır

			if (window.pageYOffset > topBarHeight) {
				menuDesktop.classList.add("fix-menu-manual");
			} else {
				menuDesktop.classList.remove("fix-menu-manual");
			}
		};
	</script>
</body>
