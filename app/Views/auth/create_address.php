...
<head>
    <title>Merilyen ❤️ Yeni Adres Ekle</title>
    <meta charset="UTF-8">
...
<section class="bg0 p-t-75 p-b-85">
    <div class="container">
        ...
        <div class="p-b-35">
            <h3 class="ltext-103 cl5">Yeni Adres Ekle</h3>
            <p class="stext-102 cl6 p-t-10">
                Siparişlerinizde kullanacağınız teslimat adresinizi eksiksiz doldurun.
            </p>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-8 m-b-30">
                <div class="profile-card">
                    ...
                    <form action="<?= base_url('/addresses/store') ?>" method="post">
                        ...
                        <div class="form-group m-b-20">
                            ...
                            <textarea name="full_address"
                                      class="form-control"
                                      placeholder="Mahalle, cadde/sokak, bina no, daire no gibi bilgileri yazınız."
                                      required></textarea>
                        </div>
            ...
            <div class="col-lg-4 m-b-30">
                <div class="address-helper-card">
                    ...
                    <p class="stext-102 cl6">
                        Sipariş oluştururken kayıtlı adresleriniz arasından seçim yapabileceksiniz.
                        Varsayılan adresiniz ödeme ekranında otomatik olarak seçili gelir.
                    </p>

                    <a href="<?= base_url('/addresses') ?>" class="stext-101 cl1 hov-cl1 trans-04">
                        Kayıtlı adreslerimi görüntüle
                    </a>
                </div>
            </div>
